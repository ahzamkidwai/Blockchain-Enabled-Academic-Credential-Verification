...
|                 Home Screen                  |                          Verification of Certificate                          |
| :------------------------------------------: | :---------------------------------------------------------------------------: |
| ![Home Screen](./screenshots/homescreen.png) | ![Verification of Certificate](./screenshots/verification-of-certificate.png) |

|                     Issue Certificate to Student                     |                           Issuing Certificate Transaction                            |
| :------------------------------------------------------------------: | :----------------------------------------------------------------------------------: |
| ![Issue Certificate](./screenshots/issue-certificate-to-student.png) | ![Issuing Transaction](./screenshots/issuing-certificate-to-student-transaction.png) |

|                       Authorized Institution                        |                       Authorize Institution Transaction                       |
| :-----------------------------------------------------------------: | :---------------------------------------------------------------------------: |
| ![Authorized Institution](./screenshots/authorized-institution.png) | ![Authorize Transaction](./screenshots/authorize-institution-transaction.png) |
...
_(Make sure to copy the deployed contract address from the terminal output)._
